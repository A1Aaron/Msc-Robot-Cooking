...
def main(target,graph):
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j1trajPLACE_CUP.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j2trajPLACE_CUP.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j3trajPLACE_CUP.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j4trajPLACE_CUP.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j5trajPLACE_CUP.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j6trajPLACE_CUP.npy").T
    ...
    # print(y6_track)
    if cobot == True:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j1trajPLACE_CUP',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j2trajPLACE_CUP',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j3trajPLACE_CUP',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j4trajPLACE_CUP',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j5trajPLACE_CUP',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j6trajPLACE_CUP',y6_track)
    else:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j1trajPLACE_CUP',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j2trajPLACE_CUP',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j3trajPLACE_CUP',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j4trajPLACE_CUP',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j5trajPLACE_CUP',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j6trajPLACE_CUP',y6_track)
