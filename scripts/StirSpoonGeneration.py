...
def main(target,graph):
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j1trajSTIR_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j2trajSTIR_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j3trajSTIR_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j4trajSTIR_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j5trajSTIR_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j6trajSTIR_SPOON.npy").T
    ...
    # print(y6_track)
    if cobot == True:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j1trajSTIR_SPOON',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j2trajSTIR_SPOON',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j3trajSTIR_SPOON',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j4trajSTIR_SPOON',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j5trajSTIR_SPOON',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j6trajSTIR_SPOON',y6_track)
    else:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j1trajSTIR_SPOON',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j2trajSTIR_SPOON',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j3trajSTIR_SPOON',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j4trajSTIR_SPOON',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j5trajSTIR_SPOON',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j6trajSTIR_SPOON',y6_track)
