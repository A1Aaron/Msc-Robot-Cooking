...
def main(target,graph):
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j1trajPICK_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j2trajPICK_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j3trajPICK_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j4trajPICK_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j5trajPICK_SPOON.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j6trajPICK_SPOON.npy").T
    ...
    # print(y6_track)
    if cobot == True:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j1trajPICK_SPOON',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j2trajPICK_SPOON',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j3trajPICK_SPOON',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j4trajPICK_SPOON',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j5trajPICK_SPOON',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j6trajPICK_SPOON',y6_track)
    else:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j1trajPICK_SPOON',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j2trajPICK_SPOON',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j3trajPICK_SPOON',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j4trajPICK_SPOON',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j5trajPICK_SPOON',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j6trajPICK_SPOON',y6_track)
