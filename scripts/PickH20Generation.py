...
def main(target,graph):
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j1trajPICK_H20.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j2trajPICK_H20.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j3trajPICK_H20.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j4trajPICK_H20.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j5trajPICK_H20.npy").T
    ...
    y_des = np.load("/home/aaron/catkin_ws/src/mycobot/data/j6trajPICK_H20.npy").T
    ...
    # print(y6_track)
    if cobot == True:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j1trajPICK_H20',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j2trajPICK_H20',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j3trajPICK_H20',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j4trajPICK_H20',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j5trajPICK_H20',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=public%20files/j6trajPICK_H20',y6_track)
    else:
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j1trajPICK_H20',y_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j2trajPICK_H20',y2_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j3trajPICK_H20',y3_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j4trajPICK_H20',y4_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j5trajPICK_H20',y5_track)
        np.save('/run/user/1000/gvfs/smb-share:server=ubuntu.local,share=cobotshare/j6trajPICK_H20',y6_track)
