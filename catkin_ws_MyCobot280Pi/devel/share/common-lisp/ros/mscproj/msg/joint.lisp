...
(cl:defmethod cl:initialize-instance :after ((m <joint>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joint)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mscproj-msg:<joint> is deprecated: use mscproj-msg:joint instead.")))

(cl:ensure-generic-function 'data-val :lambda-list '(m))
(cl:defmethod data-val ((m <joint>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mscproj-msg:data-val is deprecated.  Use mscproj-msg:data instead.")
  (data m))
