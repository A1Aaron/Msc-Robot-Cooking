...
def start():
    ...
    def begin():
        ...
        x = 1 
        j1data = load ("/shared/j1trajPLACE_SPOON.npy")
        j2data = load ("/shared/j2trajPLACE_SPOON.npy")
        j3data = load ("/shared/j3trajPLACE_SPOON.npy")
        j4data = load ("/shared/j4trajPLACE_SPOON.npy")
        j5data = load ("/shared/j5trajPLACE_SPOON.npy")
        j6data = load ("/shared/j6trajPLACE_SPOON.npy")
        start = time.time()
