...
def start():
    ...
    def begin():
        ...
        x = 1 
        j1data = load ("/shared/j1trajPOUR_H20.npy")
        j2data = load ("/shared/j2trajPOUR_H20.npy")
        j3data = load ("/shared/j3trajPOUR_H20.npy")
        j4data = load ("/shared/j4trajPOUR_H20.npy")
        j5data = load ("/shared/j5trajPOUR_H20.npy")
        j6data = load ("/shared/j6trajPOUR_H20.npy")
        start = time.time()
