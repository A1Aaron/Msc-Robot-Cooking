...
def start():
    ...
    def begin():
        ...
        x = 1 
        j1data = load ("/shared/j1trajPLACE_H20.npy")
        j2data = load ("/shared/j2trajPLACE_H20.npy")
        j3data = load ("/shared/j3trajPLACE_H20.npy")
        j4data = load ("/shared/j4trajPLACE_H20.npy")
        j5data = load ("/shared/j5trajPLACE_H20.npy")
        j6data = load ("/shared/j6trajPLACE_H20.npy")
        start = time.time()
