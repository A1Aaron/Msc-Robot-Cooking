...
def start():
    ...
    def begin():
        ...
        x = 1 
        j1data = load ("/shared/j1trajLOCATE_H20.npy")
        j2data = load ("/shared/j2trajLOCATE_H20.npy")
        j3data = load ("/shared/j3trajLOCATE_H20.npy")
        j4data = load ("/shared/j4trajLOCATE_H20.npy")
        j5data = load ("/shared/j5trajLOCATE_H20.npy")
        j6data = load ("/shared/j6trajLOCATE_H20.npy")
        start = time.time()
